...
class AesCbcCipherTest {
    ...
    companion object {
        // This is a test key and IV. In a real application,
        // you should use a secure key management system.
        private val key = AesCommonKey(
            "000102030405060708090a0b0c0d0e0f00102030405060708090a0b0c0d0e0f0".hexToByteArray()
        )
